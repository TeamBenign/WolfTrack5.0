...
#         # Generate a unique username for the first signup
#         duplicate_username = f"user_{uuid.uuid4().hex[:8]}"
...
#         user_type_dropdown.select_by_visible_text("Admin")  # Assuming there is a blank option or handle error accordingly
...
#         report_name='signup_test_report',  # Set the report name (without extension)
